...
public class VisitDto implements Serializable {
    ...
    public VisitDto(VisitEntity visitEntity) {
        ...
        this.patient = visitEntity.getPatient().getName() +
                visitEntity.getPatient().getSurname() +
                visitEntity.getPatient().getDateOfBirth()+
                visitEntity.getPatient().getKodeWithCity()+
                visitEntity.getPatient().getStreet()+
                visitEntity.getPatient().getNumber();
        this.doctor = visitEntity.getDoctor().getName() +
                visitEntity.getDoctor().getSurname();
